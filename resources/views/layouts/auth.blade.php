...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/auth/css/kaiadmin.css') }}" />
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button class="dropdown-item"><i>Logout</i></button>
       ...
       @yield('content')
        ...
        <footer class="footer">
          <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="copyright">
              2024, made with <i class=z"fa fa-heart heart text-danger"></i> by
